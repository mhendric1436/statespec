...
assert_file_contains "$TMPDIR/out-include-cpp/common/descriptors.hpp" "entities/included_entity/schema.hpp"
assert_file_exists "$TMPDIR/out-include-cpp/common/entities/included_entity/schema.hpp"
assert_file_contains "$TMPDIR/out-include-cpp/common/entities/included_entity/schema.hpp" "IncludedEntity"
assert_file_exists "$TMPDIR/out-include-cpp/common/descriptors/runtime.hpp"
assert_file_contains "$TMPDIR/out-include-cpp/common/descriptors/runtime.hpp" "IncludedQueue"
...
assert_file_contains "$TMPDIR/out-include-cpp/common/descriptors/runtime.hpp" "IncludedEntityLaunch"
