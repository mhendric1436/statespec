    ...
    static const std::array<LanguageRuntimePaths, 4> paths{{
        {
            ...
            {"api/api_application.hpp", "api/api_dispatcher.hpp", "api/api_routes.hpp",
             "api/api_server.hpp", "api/main.cpp"},
        ...
        },
        {
            ...
            {"api/backend/api_application.go", "api/backend/api_dispatcher.go",
             "api/backend/api_routes.go", "api/backend/api_server.go", "api/cmd/api/main.go"},
        ...
        },
        {
            ...
            {"api/api_application.rs", "api/api_dispatcher.rs", "api/api_routes.rs",
             "api/api_server.rs", "api/main.rs"},
