...
assert_file_exists "$TMPDIR/out-cpp/CMakeLists.txt"
assert_file_exists "$TMPDIR/out-cpp/api_artifacts.hpp"
assert_file_exists "$TMPDIR/out-cpp/worker_artifacts.hpp"
assert_file_contains "$TMPDIR/out-cpp/CMakeLists.txt" "add_library(statespec_generated_common INTERFACE)"
assert_file_contains "$TMPDIR/out-cpp/CMakeLists.txt" "add_library(statespec_generated_api INTERFACE)"
assert_file_contains "$TMPDIR/out-cpp/CMakeLists.txt" "add_library(statespec_generated_worker INTERFACE)"
