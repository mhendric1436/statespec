...
assert_file_contains "$TMPDIR/out-go/api/backend/api_codecs.go" "func DecodeStartOrderProcessingRequest"
assert_file_contains "$TMPDIR/out-go/api/backend/api_codecs.go" "func EncodeStartOrderProcessingResponse"
