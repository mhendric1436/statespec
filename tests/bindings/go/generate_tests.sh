...
assert_file_contains "$TMPDIR/out-go/api/backend/api_handlers.go" "type APITierOperationHandler interface"
...
assert_file_contains "$TMPDIR/out-go/api/backend/api_dispatcher.go" "func DispatchAPITierOperationRoute"
