...
assert_file_contains "$TMPDIR/out-go/common/backend/descriptors.go" "func BuildExternalSystemCallRequest"
assert_file_contains "$TMPDIR/out-go/common/backend/descriptors.go" "func CallExternalSystem"
