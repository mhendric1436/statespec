...
assert_file_contains "$TMPDIR/out-go/backend/api_artifacts.go" "type APITierHandler = common.APIHandler"
assert_file_contains "$TMPDIR/out-go/backend/api_artifacts.go" "func APITierRouteDescriptors"
assert_file_contains "$TMPDIR/out-go/backend/worker_artifacts.go" "type WorkerTierHandler = common.Worker"
