...
assert_file_contains "$TMPDIR/out-go/common/backend/descriptors.go" "AccountEntityName"
assert_file_contains "$TMPDIR/out-go/common/backend/descriptors.go" "OrderFieldTenantId"
assert_file_contains "$TMPDIR/out-go/common/backend/descriptors.go" "OrderIndexByTenantStatus"
assert_file_contains "$TMPDIR/out-go/common/backend/descriptors.go" "OrderIndexByTenantOrder"
assert_file_contains "$TMPDIR/out-go/common/backend/descriptors.go" "{Name: OrderFieldTenantId"
assert_file_contains "$TMPDIR/out-go/common/backend/descriptors.go" "repository.ListByIndexTx(ctx, tx, OrderIndexByTenantStatus"
assert_file_contains "$TMPDIR/out-go/common/backend/descriptors.go" "repository.ListByIndexTx(ctx, tx, OrderIndexByTenantOrder"
...
assert_file_contains "$TMPDIR/out-go/common/backend/descriptors.go" "Name: OrderIndexByTenantStatus"
