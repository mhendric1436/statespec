...
assert_file_contains "$TMPDIR/out-go/api/backend/api_handler_registry.go" "DecodeStartOrderProcessingRequest"
assert_file_contains "$TMPDIR/out-go/api/backend/api_handler_registry.go" "EncodeStartOrderProcessingResponseWithStatus"
