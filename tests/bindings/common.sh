...
assert_go_workflow_result_regression() {
    ...
    assert_file_contains "$root/worker/backend/workflows/provision_service/handlers.go" "HandleValidateRequest(context.Context, workflowcontext.WorkflowStepHandlerContext) (workflowcontext.WorkflowStepResult, error)"
    assert_file_contains "$root/worker/backend/workflows/provision_service/registry.go" "return handler.HandleValidateRequest(ctx, stepContext)"
    assert_file_contains "$root/worker/backend/workflows/provision_service/registry.go" "return handler.HandleCreateRemoteService(ctx, stepContext)"
    assert_file_contains "$root/worker/backend/workflows/provision_service/registry.go" "return handler.HandleWaitForRemoteService(ctx, stepContext)"
    ...
    assert_file_contains "$root/worker/backend/workflow_runner.go" "CompleteStep(ctx"
...
assert_java_workflow_result_regression() {
    ...
    assert_file_contains "$root/worker/com/statespec/generated/workflows/provision_service/Handlers.java" "WorkflowStepHandlers.WorkflowStepResult handleValidateRequest"
    assert_file_contains "$root/worker/com/statespec/generated/workflows/provision_service/Registry.java" "return handler.handleValidateRequest(context);"
    assert_file_contains "$root/worker/com/statespec/generated/workflows/provision_service/Registry.java" "return handler.handleCreateRemoteService(context);"
    assert_file_contains "$root/worker/com/statespec/generated/workflows/provision_service/Registry.java" "return handler.handleWaitForRemoteService(context);"
    ...
    assert_file_contains "$root/worker/com/statespec/generated/WorkflowRunner.java" "workflowStore.completeStep"
