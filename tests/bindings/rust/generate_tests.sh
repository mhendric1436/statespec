...
assert_file_contains "$TMPDIR/out-rust/common/descriptors.rs" "ACCOUNT_ENTITY_NAME"
assert_file_contains "$TMPDIR/out-rust/common/descriptors.rs" "ORDER_FIELD_TENANT_ID"
assert_file_contains "$TMPDIR/out-rust/common/descriptors.rs" "ORDER_INDEX_BY_TENANT_STATUS"
assert_file_contains "$TMPDIR/out-rust/common/descriptors.rs" "ORDER_INDEX_BY_TENANT_ORDER"
assert_file_contains "$TMPDIR/out-rust/common/descriptors.rs" "FieldDescriptor { name: ORDER_FIELD_TENANT_ID.to_string()"
assert_file_contains "$TMPDIR/out-rust/common/descriptors.rs" "ORDER_INDEX_BY_TENANT_STATUS.to_string()"
assert_file_contains "$TMPDIR/out-rust/common/descriptors.rs" "ORDER_INDEX_BY_TENANT_ORDER.to_string()"
...
assert_file_contains "$TMPDIR/out-rust/common/descriptors.rs" "name: ORDER_INDEX_BY_TENANT_STATUS.to_string()"
...
assert_file_contains "$TMPDIR/out-rust/common/descriptors.rs" "pub const ORDER_FIELD_STATUS_TYPE_NAME: &str = \"string\""
assert_file_contains "$TMPDIR/out-rust/common/descriptors.rs" "pub const ORDER_FIELD_RETRY_COUNT_TYPE_NAME: &str = \"int?\""
assert_file_contains "$TMPDIR/out-rust/common/descriptors.rs" "type_name: ORDER_FIELD_STATUS_TYPE_NAME.to_string()"
assert_file_contains "$TMPDIR/out-rust/common/descriptors.rs" "type_name: ORDER_FIELD_RETRY_COUNT_TYPE_NAME.to_string()"
