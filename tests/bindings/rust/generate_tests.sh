...
assert_file_exists "$TMPDIR/out-rust/api_artifacts.rs"
assert_file_exists "$TMPDIR/out-rust/worker_artifacts.rs"
...
assert_file_contains "$TMPDIR/out-rust/lib.rs" "pub mod api_artifacts;"
assert_file_contains "$TMPDIR/out-rust/lib.rs" "pub mod worker_artifacts;"
assert_file_contains "$TMPDIR/out-rust/api_artifacts.rs" "pub use crate::descriptors"
assert_file_contains "$TMPDIR/out-rust/api_artifacts.rs" "pub fn api_route_descriptors"
assert_file_contains "$TMPDIR/out-rust/worker_artifacts.rs" "pub use crate::descriptors::{Worker"
assert_file_contains "$TMPDIR/out-rust/worker_artifacts.rs" "pub fn worker_contexts"
assert_file_contains "$TMPDIR/out-rust/worker_artifacts.rs" "pub fn workflow_definitions"
assert_file_contains "$TMPDIR/out-rust/backend.rs" "pub enum FieldType"
assert_file_contains "$TMPDIR/out-rust/backend.rs" "pub field_type: FieldType"
assert_file_contains "$TMPDIR/out-rust/backend.rs" "pub type_name: String"
...
assert_file_contains "$TMPDIR/out-rust/descriptors.rs" "Stripe"
...
assert_file_contains "$TMPDIR/out-rust/descriptors.rs" "field_type: FieldType::String"
assert_file_contains "$TMPDIR/out-rust/descriptors.rs" "field_type: FieldType::Named"
assert_file_contains "$TMPDIR/out-rust/descriptors.rs" "field_type: FieldType::Timestamp"
assert_file_contains "$TMPDIR/out-rust/descriptors.rs" "field_type: FieldType::Optional"
assert_file_contains "$TMPDIR/out-rust/descriptors.rs" "type_name: \"OrderStatus\".to_string()"
assert_file_contains "$TMPDIR/out-rust/descriptors.rs" "type_name: \"int?\".to_string()"
