...
assert_file_exists "$TMPDIR/out-rust/common/descriptors/entities/account.rs"
assert_file_exists "$TMPDIR/out-rust/common/descriptors/entities/order.rs"
...
assert_file_contains "$TMPDIR/out-rust/common/descriptors.rs" "mod descriptor_entity_account;"
assert_file_contains "$TMPDIR/out-rust/common/descriptors.rs" "mod descriptor_entity_order;"
assert_file_contains "$TMPDIR/out-rust/common/descriptors/entities/account.rs" "pub const ACCOUNT_ENTITY_NAME"
assert_file_contains "$TMPDIR/out-rust/common/descriptors/entities/account.rs" "pub struct DefaultAccountRepository;"
assert_file_not_contains "$TMPDIR/out-rust/common/descriptors.rs" "pub struct DefaultAccountRepository;"
...
assert_file_contains "$TMPDIR/out-rust/common/descriptors/entities/account.rs" "pub trait AccountRepository"
assert_file_contains "$TMPDIR/out-rust/common/descriptors/entities/account.rs" "pub struct DefaultAccountRepository"
assert_file_contains "$TMPDIR/out-rust/common/descriptors/entities/order.rs" "pub trait OrderRepository"
assert_file_contains "$TMPDIR/out-rust/common/descriptors/entities/order.rs" "pub struct DefaultOrderRepository"
assert_file_contains "$TMPDIR/out-rust/common/descriptors/entities/account.rs" "ACCOUNT_ENTITY_NAME"
assert_file_contains "$TMPDIR/out-rust/common/descriptors/entities/order.rs" "ORDER_FIELD_TENANT_ID"
assert_file_contains "$TMPDIR/out-rust/common/descriptors/entities/order.rs" "ORDER_INDEX_BY_TENANT_STATUS"
assert_file_contains "$TMPDIR/out-rust/common/descriptors/entities/order.rs" "ORDER_INDEX_BY_TENANT_ORDER"
assert_file_contains "$TMPDIR/out-rust/common/descriptors/entities/order.rs" "FieldDescriptor { name: ORDER_FIELD_TENANT_ID.to_string()"
assert_file_contains "$TMPDIR/out-rust/common/descriptors/entities/order.rs" "ORDER_INDEX_BY_TENANT_STATUS.to_string()"
assert_file_contains "$TMPDIR/out-rust/common/descriptors/entities/order.rs" "ORDER_INDEX_BY_TENANT_ORDER.to_string()"
assert_file_contains "$TMPDIR/out-rust/common/descriptors/entities/order.rs" "create_tx"
assert_file_contains "$TMPDIR/out-rust/common/descriptors/entities/order.rs" "list_by_index_tx"
assert_file_contains "$TMPDIR/out-rust/common/descriptors/entities/order.rs" "list_by_tenant_status_tx"
assert_file_contains "$TMPDIR/out-rust/common/descriptors/entities/order.rs" "list_by_tenant_order_tx"
...
assert_file_contains "$TMPDIR/out-rust/common/descriptors/entities/order.rs" "relation_kind: Some(\"composition\".to_string())"
assert_file_contains "$TMPDIR/out-rust/common/descriptors/entities/order.rs" "name: \"valid_status\".to_string()"
assert_file_contains "$TMPDIR/out-rust/common/descriptors/entities/order.rs" "name: ORDER_INDEX_BY_TENANT_STATUS.to_string()"
assert_file_contains "$TMPDIR/out-rust/common/descriptors/entities/order.rs" "unique: true"
assert_file_contains "$TMPDIR/out-rust/common/descriptors/entities/order.rs" "garbage_collection: Some(GarbageCollectionPolicy { after: \"P30D\".to_string(), mode: \"tombstone\".to_string() })"
...
assert_file_contains "$TMPDIR/out-rust/common/descriptors/entities/order.rs" "field_type: FieldType::Timestamp"
assert_file_contains "$TMPDIR/out-rust/common/descriptors/entities/order.rs" "field_type: FieldType::Optional"
assert_file_contains "$TMPDIR/out-rust/common/descriptors/entities/order.rs" "pub const ORDER_FIELD_STATUS_TYPE_NAME: &str = \"string\""
assert_file_contains "$TMPDIR/out-rust/common/descriptors/entities/order.rs" "pub const ORDER_FIELD_RETRY_COUNT_TYPE_NAME: &str = \"int?\""
assert_file_contains "$TMPDIR/out-rust/common/descriptors/entities/order.rs" "type_name: ORDER_FIELD_STATUS_TYPE_NAME.to_string()"
assert_file_contains "$TMPDIR/out-rust/common/descriptors/entities/order.rs" "type_name: ORDER_FIELD_RETRY_COUNT_TYPE_NAME.to_string()"
