...
assert_file_contains "$TMPDIR/out-rust/api/api_handlers.rs" "pub trait ApiOperationHandler"
...
assert_file_contains "$TMPDIR/out-rust/api/api_dispatcher.rs" "pub fn dispatch_api_operation_route"
