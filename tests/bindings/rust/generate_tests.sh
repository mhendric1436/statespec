...
assert_file_contains "$TMPDIR/out-rust/common/runtime/entity_gc_descriptors.rs" "\"Order\""
assert_file_contains "$TMPDIR/out-rust/common/runtime/entity_gc_descriptors.rs" "\"Failed\""
