...
assert_file_contains "$TMPDIR/out-api-entities-java/api/com/statespec/generated/entities/account/Handlers.java" "document.put(com.statespec.generated.entities.account.Constants.ACCOUNT_FIELD_CREATED_AT, com.statespec.backend.Json.string(java.time.Instant.now().toString()))"
