...
assert_file_contains "$TMPDIR/out-api-entities-java/api/com/statespec/generated/ApiHandlerRegistryAccount.java" "com.statespec.generated.entities.account.Model.ACCOUNT_FIELD_CREATED_AT"
assert_file_contains "$TMPDIR/out-api-entities-java/api/com/statespec/generated/ApiHandlerRegistryAccount.java" "com.statespec.generated.entities.account.Model.ACCOUNT_FIELD_UPDATED_AT"
assert_file_contains "$TMPDIR/out-api-entities-java/api/com/statespec/generated/ApiHandlerRegistryAccount.java" "com.statespec.generated.entities.account.Model.ACCOUNT_FIELD_STATUS"
assert_file_contains "$TMPDIR/out-api-entities-java/api/com/statespec/generated/ApiHandlerRegistryAccount.java" "document.put(com.statespec.generated.entities.account.Model.ACCOUNT_FIELD_CREATED_AT, com.statespec.backend.Json.string(java.time.Instant.now().toString()))"
assert_file_contains "$TMPDIR/out-api-entities-java/api/com/statespec/generated/ApiHandlerRegistryAccount.java" "document.put(com.statespec.generated.entities.account.Model.ACCOUNT_FIELD_STATUS, com.statespec.backend.Json.string(com.statespec.generated.entities.account.Model.ACCOUNT_STATUS_ACTIVE))"
...
assert_file_contains "$TMPDIR/out-api-entities-java/api/com/statespec/generated/ApiHandlerRegistryAccount.java" "repository.listByAccountStatusTx"
assert_file_contains "$TMPDIR/out-api-entities-java/api/com/statespec/generated/ApiHandlerRegistryProject.java" "repository.listByProjectStatusTx"
