...
assert_file_contains "$TMPDIR/out-app-java/common/com/statespec/backend/runtime/EntityGcDescriptors.java" "private static Descriptor serviceInstanceDescriptor()"
assert_file_contains "$TMPDIR/out-app-java/common/com/statespec/backend/runtime/EntityGcDescriptors.java" "serviceInstanceDescriptor()"
