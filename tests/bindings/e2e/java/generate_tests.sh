...
assert_file_contains "$TMPDIR/out-api-entities-java/api/com/statespec/generated/ApiHandlerRegistry.java" "Descriptors.ACCOUNT_FIELD_CREATED_AT"
assert_file_contains "$TMPDIR/out-api-entities-java/api/com/statespec/generated/ApiHandlerRegistry.java" "Descriptors.ACCOUNT_FIELD_UPDATED_AT"
assert_file_contains "$TMPDIR/out-api-entities-java/api/com/statespec/generated/ApiHandlerRegistry.java" "Descriptors.ACCOUNT_FIELD_STATUS"
assert_file_contains "$TMPDIR/out-api-entities-java/api/com/statespec/generated/ApiHandlerRegistry.java" "document.put(Descriptors.ACCOUNT_FIELD_CREATED_AT, com.statespec.backend.Json.string(java.time.Instant.now().toString()))"
assert_file_contains "$TMPDIR/out-api-entities-java/api/com/statespec/generated/ApiHandlerRegistry.java" "document.put(Descriptors.ACCOUNT_FIELD_STATUS, com.statespec.backend.Json.string(Descriptors.ACCOUNT_STATUS_ACTIVE))"
...
assert_file_contains "$TMPDIR/out-api-entities-java/api/com/statespec/generated/ApiHandlerRegistry.java" "repository.listByTenantAccountTx"
assert_file_contains "$TMPDIR/out-api-entities-java/api/com/statespec/generated/ApiHandlerRegistry.java" "repository.listByAccountStatusTx"
assert_file_contains "$TMPDIR/out-api-entities-java/api/com/statespec/generated/ApiHandlerRegistry.java" "repository.listByProjectStatusTx"
assert_file_contains "$TMPDIR/out-api-entities-java/common/com/statespec/generated/Descriptors.java" "listByTenantProjectTx"
assert_file_contains "$TMPDIR/out-api-entities-java/common/com/statespec/generated/Descriptors.java" "listByTenantTaskTx"
assert_file_contains "$TMPDIR/out-api-entities-java/common/com/statespec/generated/Descriptors.java" "listByAccountPriorityTx"
assert_file_contains "$TMPDIR/out-api-entities-java/common/com/statespec/generated/Descriptors.java" "public static final String ACCOUNT_ENTITY_NAME = \"Account\""
assert_file_contains "$TMPDIR/out-api-entities-java/common/com/statespec/generated/Descriptors.java" "public static final String ACCOUNT_FIELD_TENANT_ID = \"tenant_id\""
assert_file_contains "$TMPDIR/out-api-entities-java/common/com/statespec/generated/Descriptors.java" "public static final String ACCOUNT_FIELD_CREATED_AT_TYPE_NAME = \"timestamp\""
assert_file_contains "$TMPDIR/out-api-entities-java/common/com/statespec/generated/Descriptors.java" "public static final String ACCOUNT_FIELD_STATUS_TYPE_NAME = \"string\""
assert_file_contains "$TMPDIR/out-api-entities-java/common/com/statespec/generated/Descriptors.java" "public static final String ACCOUNT_INDEX_BY_TENANT_ACCOUNT = \"by_tenant_account\""
assert_file_contains "$TMPDIR/out-api-entities-java/common/com/statespec/generated/Descriptors.java" "new FieldDescriptor(ACCOUNT_FIELD_CREATED_AT, FieldType.TIMESTAMP, ACCOUNT_FIELD_CREATED_AT_TYPE_NAME, true)"
assert_file_contains "$TMPDIR/out-api-entities-java/common/com/statespec/generated/Descriptors.java" "new FieldDescriptor(ACCOUNT_FIELD_STATUS, FieldType.STRING, ACCOUNT_FIELD_STATUS_TYPE_NAME, true)"
assert_file_contains "$TMPDIR/out-api-entities-java/common/com/statespec/generated/Descriptors.java" "public static final String CREATE_ACCOUNT_REQUEST_SHAPE_NAME = \"CreateAccountRequest\""
assert_file_contains "$TMPDIR/out-api-entities-java/common/com/statespec/generated/Descriptors.java" "public static final String CREATE_ACCOUNT_REQUEST_FIELD_TENANT_ID = \"tenant_id\""
assert_file_contains "$TMPDIR/out-api-entities-java/common/com/statespec/generated/Descriptors.java" "public static final String CREATE_ACCOUNT_REQUEST_FIELD_TENANT_ID_TYPE_NAME = \"string\""
assert_file_contains "$TMPDIR/out-api-entities-java/common/com/statespec/generated/Descriptors.java" "new FieldDescriptor(CREATE_ACCOUNT_REQUEST_FIELD_TENANT_ID, FieldType.STRING, CREATE_ACCOUNT_REQUEST_FIELD_TENANT_ID_TYPE_NAME, true)"
assert_file_contains "$TMPDIR/out-api-entities-java/common/com/statespec/generated/Descriptors.java" "List.of(ACCOUNT_FIELD_TENANT_ID, ACCOUNT_FIELD_ACCOUNT_ID)"
...
assert_file_contains "$TMPDIR/out-api-entities-java/api/com/statespec/generated/ApiHandlerRegistry.java" "document.put(Descriptors.PROJECT_FIELD_UPDATED_AT"
