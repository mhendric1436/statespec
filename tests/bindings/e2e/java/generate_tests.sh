...
assert_file_contains "$TMPDIR/out-api-entities-java/api/com/statespec/generated/entities/account/Handlers.java" "com.statespec.generated.entities.account.Model.ACCOUNT_FIELD_CREATED_AT"
assert_file_contains "$TMPDIR/out-api-entities-java/api/com/statespec/generated/entities/account/Handlers.java" "com.statespec.generated.entities.account.Model.ACCOUNT_FIELD_UPDATED_AT"
assert_file_contains "$TMPDIR/out-api-entities-java/api/com/statespec/generated/entities/account/Handlers.java" "com.statespec.generated.entities.account.Model.ACCOUNT_FIELD_STATUS"
assert_file_contains "$TMPDIR/out-api-entities-java/api/com/statespec/generated/entities/account/Handlers.java" "document.put(com.statespec.generated.entities.account.Model.ACCOUNT_FIELD_CREATED_AT, com.statespec.backend.Json.string(java.time.Instant.now().toString()))"
assert_file_contains "$TMPDIR/out-api-entities-java/api/com/statespec/generated/entities/account/Handlers.java" "document.put(com.statespec.generated.entities.account.Model.ACCOUNT_FIELD_STATUS, com.statespec.backend.Json.string(com.statespec.generated.entities.account.Model.ACCOUNT_STATUS_ACTIVE))"
...
assert_file_contains "$TMPDIR/out-api-entities-java/api/com/statespec/generated/entities/account/Handlers.java" "repository.listByAccountStatusTx"
assert_file_contains "$TMPDIR/out-api-entities-java/api/com/statespec/generated/entities/project/Handlers.java" "repository.listByProjectStatusTx"
...
assert_file_contains "$TMPDIR/out-api-entities-java/api/com/statespec/generated/entities/account/Catalog.java" "handleListAccountProjects"
assert_file_not_exists "$TMPDIR/out-api-entities-java/api/com/statespec/generated/shapes/CreateAccountRequest.java"
assert_file_contains "$TMPDIR/out-api-entities-java/api/com/statespec/generated/shapes/ShapeCatalog.java" "com.statespec.generated.entities.account.Shapes.shapeDescriptors()"
...
assert_file_contains "$TMPDIR/out-api-entities-java/api/com/statespec/generated/entities/account/Shapes.java" "CREATE_ACCOUNT_REQUEST_FIELD_DISPLAY_NAME = \"display_name\""
assert_file_contains "$TMPDIR/out-api-entities-java/api/com/statespec/generated/entities/account/Shapes.java" "CREATE_ACCOUNT_REQUEST_FIELD_DISPLAY_NAME_TYPE_NAME = \"string\""
assert_file_contains "$TMPDIR/out-api-entities-java/api/com/statespec/generated/entities/account/Shapes.java" "new FieldDescriptor(CREATE_ACCOUNT_REQUEST_FIELD_DISPLAY_NAME, FieldType.STRING, CREATE_ACCOUNT_REQUEST_FIELD_DISPLAY_NAME_TYPE_NAME, true)"
...
assert_file_contains "$TMPDIR/out-api-entities-java/api/com/statespec/generated/entities/project/Handlers.java" "document.put(com.statespec.generated.entities.project.Model.PROJECT_FIELD_UPDATED_AT"
assert_file_contains "$TMPDIR/out-api-entities-java/api/com/statespec/generated/entities/project/Handlers.java" "var requestedStatus = com.statespec.generated.entities.project.Model.PROJECT_STATUS_DELETED"
