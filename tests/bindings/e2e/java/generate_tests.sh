...
assert_file_contains "$TMPDIR/out-api-entities-java/api/com/statespec/generated/ApiHandlerRegistry.java" "new AccountDescriptorModule.DefaultAccountRepository()"
assert_file_contains "$TMPDIR/out-api-entities-java/api/com/statespec/generated/ApiHandlerRegistry.java" "new ProjectDescriptorModule.DefaultProjectRepository()"
assert_file_contains "$TMPDIR/out-api-entities-java/api/com/statespec/generated/ApiHandlerRegistry.java" "new TaskDescriptorModule.DefaultTaskRepository()"
...
assert_file_contains "$TMPDIR/out-api-entities-java/api/com/statespec/generated/ApiHandlerRegistry.java" "AccountDescriptorModule.ACCOUNT_FIELD_CREATED_AT"
assert_file_contains "$TMPDIR/out-api-entities-java/api/com/statespec/generated/ApiHandlerRegistry.java" "AccountDescriptorModule.ACCOUNT_FIELD_UPDATED_AT"
assert_file_contains "$TMPDIR/out-api-entities-java/api/com/statespec/generated/ApiHandlerRegistry.java" "AccountDescriptorModule.ACCOUNT_FIELD_STATUS"
assert_file_contains "$TMPDIR/out-api-entities-java/api/com/statespec/generated/ApiHandlerRegistry.java" "document.put(AccountDescriptorModule.ACCOUNT_FIELD_CREATED_AT, com.statespec.backend.Json.string(java.time.Instant.now().toString()))"
assert_file_contains "$TMPDIR/out-api-entities-java/api/com/statespec/generated/ApiHandlerRegistry.java" "document.put(AccountDescriptorModule.ACCOUNT_FIELD_STATUS, com.statespec.backend.Json.string(AccountDescriptorModule.ACCOUNT_STATUS_ACTIVE))"
...
assert_file_contains "$TMPDIR/out-api-entities-java/api/com/statespec/generated/ApiHandlerRegistry.java" "document.put(ProjectDescriptorModule.PROJECT_FIELD_UPDATED_AT"
assert_file_contains "$TMPDIR/out-api-entities-java/api/com/statespec/generated/ApiHandlerRegistry.java" "var requestedStatus = ProjectDescriptorModule.PROJECT_STATUS_DELETED"
