...
assert_file_contains "$TMPDIR/out-app-java/worker/com/statespec/generated/WorkflowStepHandlers.java" "WorkflowStepResult invoke(Backend backend, Context context)"
