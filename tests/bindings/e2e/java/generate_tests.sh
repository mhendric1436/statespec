...
assert_file_contains "$TMPDIR/out-api-entities-java/api/com/statespec/generated/servers/entity_api/Catalog.java" "appendAccountApiServerNames"
assert_file_contains "$TMPDIR/out-api-entities-java/api/com/statespec/generated/servers/entity_api/Catalog.java" "appendProjectApiServerNames(serves)"
assert_file_contains "$TMPDIR/out-api-entities-java/api/com/statespec/generated/servers/entity_api/Catalog.java" "appendTaskApiServerNames(serves)"
