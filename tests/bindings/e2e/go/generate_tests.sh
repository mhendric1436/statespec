...
assert_file_contains "$TMPDIR/out-api-entities-go/api/backend/servers/entity_api/catalog.go" "func appendAccountAPIServerNames"
assert_file_contains "$TMPDIR/out-api-entities-go/api/backend/servers/entity_api/catalog.go" "appendProjectAPIServerNames(&serves)"
assert_file_contains "$TMPDIR/out-api-entities-go/api/backend/servers/entity_api/catalog.go" "appendTaskAPIServerNames(&serves)"
