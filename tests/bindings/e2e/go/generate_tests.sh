...
assert_file_contains "$TMPDIR/out-api-entities-go/api/backend/entities/account/handlers.go" "repository.ListByAccountStatusTx"
assert_file_contains "$TMPDIR/out-api-entities-go/api/backend/entities/project/handlers.go" "repository.ListByProjectStatusTx"
...
assert_file_contains "$TMPDIR/out-api-entities-go/api/backend/entities/account/catalog.go" "HandleListAccountProjects"
...
assert_file_contains "$TMPDIR/out-api-entities-go/api/backend/shapes/catalog.go" "account.CreateAccountRequestShapeDescriptors()"
...
assert_file_contains "$TMPDIR/out-api-entities-go/api/backend/entities/account/shapes.go" "CreateAccountRequestFieldDisplayName = \"display_name\""
assert_file_contains "$TMPDIR/out-api-entities-go/api/backend/entities/account/shapes.go" "CreateAccountRequestFieldDisplayNameTypeName = \"string\""
assert_file_contains "$TMPDIR/out-api-entities-go/api/backend/entities/account/shapes.go" "{Name: CreateAccountRequestFieldDisplayName, Type: common.FieldTypeString, TypeName: CreateAccountRequestFieldDisplayNameTypeName, Required: true}"
