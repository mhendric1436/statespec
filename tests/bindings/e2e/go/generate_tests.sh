...
assert_file_contains "$TMPDIR/out-api-entities-go/api/backend/entities/account/handlers.go" "document[account.AccountFieldCreatedAt] = common.JSONString(time.Now().UTC().Format(time.RFC3339))"
...
assert_file_contains "$TMPDIR/out-api-entities-go/api/backend/entities/account/codecs.go" "var _ = entityconstants.AccountEntityName"
...
assert_file_contains "$TMPDIR/out-api-entities-go/api/backend/entities/project/codecs.go" "var _ = entityconstants.ProjectEntityName"
...
assert_file_contains "$TMPDIR/out-api-entities-go/api/backend/entities/task/codecs.go" "var _ = entityconstants.TaskEntityName"
...
assert_file_contains "$TMPDIR/out-api-entities-go/api/backend/entities/account/catalog.go" "accountconstants \"statespec-generated/common/entities/account\""
assert_file_contains "$TMPDIR/out-api-entities-go/api/backend/entities/account/catalog.go" "Path: entityCatalogStringPtr(\"/v1/tenants/{\" + accountconstants.AccountFieldTenantId"
...
assert_file_contains "$TMPDIR/out-api-entities-go/api/backend/descriptors/create_account.go" "accountconstants \"statespec-generated/common/entities/account\""
assert_file_contains "$TMPDIR/out-api-entities-go/api/backend/descriptors/create_account.go" "Path: createAccountStringPtr(\"/v1/tenants/{\" + accountconstants.AccountFieldTenantId"
assert_file_not_contains "$TMPDIR/out-api-entities-go/api/backend/descriptors/create_account.go" "common/backend/descriptors"
assert_file_not_contains "$TMPDIR/out-api-entities-go/api/backend/descriptors/create_account.go" "common/entities/account/model"
assert_file_contains "$TMPDIR/out-api-entities-go/api/backend/descriptors/create_project.go" "projectconstants \"statespec-generated/common/entities/project\""
assert_file_contains "$TMPDIR/out-api-entities-go/api/backend/descriptors/create_project.go" "projectconstants.ProjectFieldProjectId"
assert_file_contains "$TMPDIR/out-api-entities-go/api/backend/descriptors/create_task.go" "taskconstants \"statespec-generated/common/entities/task\""
assert_file_contains "$TMPDIR/out-api-entities-go/api/backend/descriptors/create_task.go" "taskconstants.TaskFieldTaskId"
...
assert_file_contains "$TMPDIR/out-api-entities-go/api/backend/api_handler_registry.go" "account.NewHandlerRegistry"
