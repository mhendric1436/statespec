...
assert_file_contains "$TMPDIR/out-api-entities-go/api/backend/api_handler_registry_account.go" "repository := common.DefaultAccountRepository{}"
assert_file_contains "$TMPDIR/out-api-entities-go/api/backend/api_handler_registry_project.go" "repository := common.DefaultProjectRepository{}"
assert_file_contains "$TMPDIR/out-api-entities-go/api/backend/api_handler_registry_task.go" "repository := common.DefaultTaskRepository{}"
...
assert_file_contains "$TMPDIR/out-api-entities-go/api/backend/api_handler_registry_account.go" "common.AccountFieldCreatedAt"
assert_file_contains "$TMPDIR/out-api-entities-go/api/backend/api_handler_registry_account.go" "common.AccountFieldUpdatedAt"
assert_file_contains "$TMPDIR/out-api-entities-go/api/backend/api_handler_registry_account.go" "common.AccountFieldStatus"
assert_file_contains "$TMPDIR/out-api-entities-go/api/backend/api_handler_registry_account.go" "document[common.AccountFieldCreatedAt] = common.JSONString(time.Now().UTC().Format(time.RFC3339))"
assert_file_contains "$TMPDIR/out-api-entities-go/api/backend/api_handler_registry_account.go" "document[common.AccountFieldStatus] = common.JSONString(common.AccountStatusActive)"
...
assert_file_contains "$TMPDIR/out-api-entities-go/api/backend/api_handler_registry_project.go" "repository.ListByAccountStatusTx"
assert_file_contains "$TMPDIR/out-api-entities-go/api/backend/api_handler_registry_task.go" "repository.ListByProjectStatusTx"
...
assert_file_contains "$TMPDIR/out-api-entities-go/api/backend/api_handler_registry_project.go" "updatedDocument[common.ProjectFieldUpdatedAt]"
assert_file_contains "$TMPDIR/out-api-entities-go/api/backend/api_handler_registry_project.go" "requestedStatus := common.ProjectStatusDeleted"
