...
assert_file_contains "$TMPDIR/out-app-go/worker/cmd/worker/main.go" "invokers := worker.WorkflowStepInvokerMap{}"
assert_file_contains "$TMPDIR/out-app-go/worker/cmd/worker/main.go" "worker.RegisterProvisionServiceWorkflowStepInvokers(invokers,"
assert_file_not_contains "$TMPDIR/out-app-go/worker/cmd/worker/main.go" "worker.NewDefaultWorkflowStepHandlerBundle"
...
assert_file_contains "$TMPDIR/out-app-go/worker/backend/workflow_runner.go" "type periodicWorkflowKeepAlive struct"
assert_file_contains "$TMPDIR/out-app-go/worker/backend/workflow_runner.go" "keepAlive.Start()"
assert_file_contains "$TMPDIR/out-app-go/worker/backend/workflow_runner.go" "keepAlive.Stop()"
...
assert_file_contains "$TMPDIR/out-app-go/worker/backend/workflow_step_handlers.go" "type WorkflowStepInvoker func(context.Context, common.Backend, common.Transaction, WorkflowStepHandlerContext) (WorkflowStepResult, error)"
assert_file_contains "$TMPDIR/out-app-go/worker/backend/workflow_step_handlers.go" "type WorkflowStepInvokerMap map[string]WorkflowStepInvoker"
assert_file_not_contains "$TMPDIR/out-app-go/worker/backend/workflow_step_handlers.go" "WorkflowStepHandlerBundle"
assert_file_not_contains "$TMPDIR/out-app-go/worker/backend/workflow_step_handlers.go" "DefaultWorkflowStepHandlerBundle"
assert_file_contains "$TMPDIR/out-app-go/worker/backend/worker_registry.go" "func RegisterProvisionServiceWorkflowStepInvokers"
assert_file_contains "$TMPDIR/out-app-go/worker/backend/workflows/provision_service/registry.go" "func RegisterWorkflowStepInvokers"
...
assert_file_contains "$TMPDIR/out-app-go/worker/backend/workflows/provision_service/registry.go" "\"ProvisionService:1:validate_request\""
assert_file_contains "$TMPDIR/out-app-go/worker/backend/workflows/provision_service/registry.go" "\"ProvisionService:1:create_remote_service\""
...
assert_file_not_contains "$TMPDIR/out-app-go/worker/backend/workflow_step_handlers.go" "ProvisionServiceStepHandler"
...
assert_file_contains "$TMPDIR/out-app-go/worker/backend/workflows/provision_service/handlers.go" "HandleValidateRequest(context.Context, common.Transaction, workflowcontext.WorkflowStepHandlerContext) (workflowcontext.WorkflowStepResult, error)"
assert_file_contains "$TMPDIR/out-app-go/worker/backend/workflow_runner.go" "Invokers      WorkflowStepInvokerMap"
assert_file_contains "$TMPDIR/out-app-go/worker/backend/workflow_runner.go" "tx, err := runner.Backend.Begin(ctx)"
assert_file_contains "$TMPDIR/out-app-go/worker/backend/workflow_runner.go" "runner.revalidateClaimedStep(ctx, tx, record)"
assert_file_contains "$TMPDIR/out-app-go/worker/backend/workflow_runner.go" "runner.WorkflowStore.CompleteStepTx"
assert_file_contains "$TMPDIR/out-app-go/worker/backend/workflow_runner.go" "runner.WorkflowStore.FailStepTx"
assert_file_contains "$TMPDIR/out-app-go/worker/backend/workflow_runner.go" "runner.WorkflowStore.CancelTx"
assert_file_contains "$TMPDIR/out-app-go/worker/backend/workflow_runner.go" "invoker, handled := runner.Invokers[stepKey]"
assert_file_not_contains "$TMPDIR/out-app-go/worker/backend/workflow_runner.go" "WorkflowStepInvokers()"
...
assert_go_workflow_result_regression "$TMPDIR/out-app-go"
