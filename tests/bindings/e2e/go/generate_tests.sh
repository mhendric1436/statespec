...
assert_file_contains "$TMPDIR/out-app-go/worker/backend/workflow_step_handlers.go" "type WorkflowStepInvoker func(context.Context, common.Backend, WorkflowStepHandlerContext) (WorkflowStepResult, error)"
