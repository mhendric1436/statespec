...
assert_file_contains "$TMPDIR/out-app-go/api/backend/api_dispatcher.go" "type APITierHandlerInvoker"
assert_file_contains "$TMPDIR/out-app-go/api/backend/api_dispatcher.go" "invoker, ok := apiTierHandlerLookupMap[route.ApiName]"
