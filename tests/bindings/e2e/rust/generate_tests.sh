...
assert_file_contains "$TMPDIR/out-app-rust/common/runtime/entity_gc_descriptors.rs" "pub fn service_instance_entity_gc_descriptor() -> EntityGcDescriptor"
assert_file_contains "$TMPDIR/out-app-rust/common/runtime/entity_gc_descriptors.rs" "service_instance_entity_gc_descriptor(),"
