...
assert_file_contains "$TMPDIR/out-api-entities-rust/api/entities/account/handlers.rs" "document.insert(crate::entity_account::model::ACCOUNT_FIELD_CREATED_AT.to_string(), Json::String(generated_api_timestamp()))"
assert_file_contains "$TMPDIR/out-api-entities-rust/api/entities/account/handlers.rs" "document.insert(crate::entity_account::model::ACCOUNT_FIELD_STATUS.to_string(), Json::String(crate::entity_account::model::ACCOUNT_STATUS_ACTIVE.to_string()))"
...
assert_file_contains "$TMPDIR/out-api-entities-rust/api/entities/account/handlers.rs" "list_by_account_status_tx"
assert_file_contains "$TMPDIR/out-api-entities-rust/api/entities/project/handlers.rs" "list_by_project_status_tx"
...
assert_file_contains "$TMPDIR/out-api-entities-rust/api/entities/account/catalog.rs" "handle_list_account_projects"
assert_file_not_exists "$TMPDIR/out-api-entities-rust/api/shapes/create_account_request.rs"
assert_file_contains "$TMPDIR/out-api-entities-rust/api/shapes.rs" "entity_account_shapes::create_account_request_shape_descriptors()"
assert_file_contains "$TMPDIR/out-api-entities-rust/api/entities/account/shapes.rs" "CREATE_ACCOUNT_REQUEST_SHAPE_NAME"
assert_file_contains "$TMPDIR/out-api-entities-rust/api/entities/account/shapes.rs" "CREATE_ACCOUNT_REQUEST_FIELD_DISPLAY_NAME"
assert_file_contains "$TMPDIR/out-api-entities-rust/api/entities/account/shapes.rs" "CREATE_ACCOUNT_REQUEST_FIELD_DISPLAY_NAME_TYPE_NAME"
assert_file_contains "$TMPDIR/out-api-entities-rust/api/entities/account/shapes.rs" "FieldDescriptor { name: CREATE_ACCOUNT_REQUEST_FIELD_DISPLAY_NAME.to_string(), field_type: FieldType::String, type_name: CREATE_ACCOUNT_REQUEST_FIELD_DISPLAY_NAME_TYPE_NAME.to_string(), required: true }"
...
assert_file_contains "$TMPDIR/out-api-entities-rust/api/entities/project/handlers.rs" "document.insert(crate::entity_project::model::PROJECT_FIELD_UPDATED_AT.to_string()"
assert_file_contains "$TMPDIR/out-api-entities-rust/api/entities/project/handlers.rs" "let requested_status = crate::entity_project::model::PROJECT_STATUS_DELETED.to_string()"
