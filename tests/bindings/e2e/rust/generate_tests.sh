...
assert_file_contains "$TMPDIR/out-api-entities-rust/api/entities/account/handlers.rs" "document.insert(crate::entity_account::constants::ACCOUNT_FIELD_CREATED_AT.to_string(), Json::String(generated_api_timestamp()))"
...
assert_file_contains "$TMPDIR/out-api-entities-rust/api/descriptors/create_account.rs" "use crate::entity_account::constants as entity_constants;"
assert_file_contains "$TMPDIR/out-api-entities-rust/api/descriptors/create_account.rs" "path: Some([\"/v1/tenants/{\", entity_constants::ACCOUNT_FIELD_TENANT_ID"
assert_file_not_contains "$TMPDIR/out-api-entities-rust/api/descriptors/create_account.rs" "use crate::descriptors::*"
assert_file_not_contains "$TMPDIR/out-api-entities-rust/api/descriptors/create_account.rs" "model"
assert_file_contains "$TMPDIR/out-api-entities-rust/api/descriptors/create_project.rs" "use crate::entity_project::constants as entity_constants;"
assert_file_contains "$TMPDIR/out-api-entities-rust/api/descriptors/create_project.rs" "entity_constants::PROJECT_FIELD_PROJECT_ID"
assert_file_contains "$TMPDIR/out-api-entities-rust/api/descriptors/create_task.rs" "use crate::entity_task::constants as entity_constants;"
assert_file_contains "$TMPDIR/out-api-entities-rust/api/descriptors/create_task.rs" "entity_constants::TASK_FIELD_TASK_ID"
