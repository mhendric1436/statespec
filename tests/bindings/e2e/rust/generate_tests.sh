...
assert_file_contains "$TMPDIR/out-api-entities-rust/api/api_handler_registry.rs" "list_by_tenant_project_tx"
assert_file_contains "$TMPDIR/out-api-entities-rust/api/api_handler_registry.rs" "list_by_tenant_task_tx"
