...
assert_file_contains "$TMPDIR/out-api-entities-rust/api/api_handler_registry.rs" "document.insert(ACCOUNT_FIELD_CREATED_AT.to_string(), Json::String(\"0\".to_string()))"
