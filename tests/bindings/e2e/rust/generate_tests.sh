...
assert_file_contains "$TMPDIR/out-api-entities-rust/api/api_handler_registry.rs" "ACCOUNT_FIELD_CREATED_AT"
assert_file_contains "$TMPDIR/out-api-entities-rust/api/api_handler_registry.rs" "ACCOUNT_FIELD_UPDATED_AT"
assert_file_contains "$TMPDIR/out-api-entities-rust/api/api_handler_registry.rs" "ACCOUNT_FIELD_STATUS"
assert_file_contains "$TMPDIR/out-api-entities-rust/api/api_handler_registry.rs" "fn generated_api_timestamp() -> String"
assert_file_contains "$TMPDIR/out-api-entities-rust/api/api_handler_registry.rs" "document.insert(ACCOUNT_FIELD_CREATED_AT.to_string(), Json::String(generated_api_timestamp()))"
assert_file_contains "$TMPDIR/out-api-entities-rust/api/api_handler_registry.rs" "document.insert(ACCOUNT_FIELD_STATUS.to_string(), Json::String(ACCOUNT_STATUS_ACTIVE.to_string()))"
...
assert_file_contains "$TMPDIR/out-api-entities-rust/api/api_handler_registry.rs" "list_by_tenant_account_tx"
assert_file_contains "$TMPDIR/out-api-entities-rust/api/api_handler_registry.rs" "list_by_account_status_tx"
assert_file_contains "$TMPDIR/out-api-entities-rust/api/api_handler_registry.rs" "list_by_project_status_tx"
assert_file_contains "$TMPDIR/out-api-entities-rust/common/descriptors.rs" "list_by_tenant_project_tx"
assert_file_contains "$TMPDIR/out-api-entities-rust/common/descriptors.rs" "list_by_tenant_task_tx"
assert_file_contains "$TMPDIR/out-api-entities-rust/common/descriptors.rs" "list_by_account_priority_tx"
assert_file_contains "$TMPDIR/out-api-entities-rust/common/descriptors.rs" "pub const ACCOUNT_ENTITY_NAME: &str = \"Account\""
assert_file_contains "$TMPDIR/out-api-entities-rust/common/descriptors.rs" "pub const ACCOUNT_FIELD_TENANT_ID: &str = \"tenant_id\""
assert_file_contains "$TMPDIR/out-api-entities-rust/common/descriptors.rs" "pub const ACCOUNT_FIELD_CREATED_AT_TYPE_NAME: &str = \"timestamp\""
assert_file_contains "$TMPDIR/out-api-entities-rust/common/descriptors.rs" "pub const ACCOUNT_FIELD_STATUS_TYPE_NAME: &str = \"string\""
assert_file_contains "$TMPDIR/out-api-entities-rust/common/descriptors.rs" "pub const ACCOUNT_INDEX_BY_TENANT_ACCOUNT: &str = \"by_tenant_account\""
assert_file_contains "$TMPDIR/out-api-entities-rust/common/descriptors.rs" "FieldDescriptor { name: ACCOUNT_FIELD_CREATED_AT.to_string(), field_type: FieldType::Timestamp, type_name: ACCOUNT_FIELD_CREATED_AT_TYPE_NAME.to_string(), required: true }"
assert_file_contains "$TMPDIR/out-api-entities-rust/common/descriptors.rs" "FieldDescriptor { name: ACCOUNT_FIELD_STATUS.to_string(), field_type: FieldType::String, type_name: ACCOUNT_FIELD_STATUS_TYPE_NAME.to_string(), required: true }"
assert_file_contains "$TMPDIR/out-api-entities-rust/common/descriptors.rs" "pub const CREATE_ACCOUNT_REQUEST_SHAPE_NAME: &str = \"CreateAccountRequest\""
assert_file_contains "$TMPDIR/out-api-entities-rust/common/descriptors.rs" "pub const CREATE_ACCOUNT_REQUEST_FIELD_TENANT_ID: &str = \"tenant_id\""
assert_file_contains "$TMPDIR/out-api-entities-rust/common/descriptors.rs" "pub const CREATE_ACCOUNT_REQUEST_FIELD_TENANT_ID_TYPE_NAME: &str = \"string\""
assert_file_contains "$TMPDIR/out-api-entities-rust/common/descriptors.rs" "FieldDescriptor { name: CREATE_ACCOUNT_REQUEST_FIELD_TENANT_ID.to_string(), field_type: FieldType::String, type_name: CREATE_ACCOUNT_REQUEST_FIELD_TENANT_ID_TYPE_NAME.to_string(), required: true }"
assert_file_contains "$TMPDIR/out-api-entities-rust/common/descriptors.rs" "key_fields: vec![ACCOUNT_FIELD_TENANT_ID.to_string(), ACCOUNT_FIELD_ACCOUNT_ID.to_string()]"
...
assert_file_contains "$TMPDIR/out-api-entities-rust/api/api_handler_registry.rs" "document.insert(PROJECT_FIELD_UPDATED_AT.to_string()"
