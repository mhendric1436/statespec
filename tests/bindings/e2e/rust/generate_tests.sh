...
assert_file_contains "$TMPDIR/out-e2e-rust/api/descriptors/catalog.rs" "server_operator_api_constants::OPERATOR_API_SERVER_NAME"
...
assert_file_contains "$TMPDIR/out-api-entities-rust/api/descriptors/catalog.rs" "entity_account_catalog::api_names()"
assert_file_contains "$TMPDIR/out-api-entities-rust/api/descriptors/catalog.rs" "entity_account_catalog::constants::CREATE_ACCOUNT_API_NAME"
assert_file_contains "$TMPDIR/out-api-entities-rust/api/descriptors/catalog.rs" "server_entity_api_constants::ENTITY_API_SERVER_NAME"
