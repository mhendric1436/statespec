...
assert_file_contains "$TMPDIR/out-api-entities-rust/api/servers/entity_api/catalog.rs" "entity_account_catalog::api_names()"
assert_file_contains "$TMPDIR/out-api-entities-rust/api/servers/entity_api/catalog.rs" "entity_account_catalog::constants::CREATE_ACCOUNT_API_NAME"
assert_file_contains "$TMPDIR/out-api-entities-rust/api/servers/entity_api/catalog.rs" "constants::ENTITY_API_SERVER_NAME"
assert_file_contains "$TMPDIR/out-api-entities-rust/api/servers/entity_api/catalog.rs" "fn append_account_api_server_names"
assert_file_contains "$TMPDIR/out-api-entities-rust/api/servers/entity_api/catalog.rs" "append_project_api_server_names(&mut serves)"
assert_file_contains "$TMPDIR/out-api-entities-rust/api/servers/entity_api/catalog.rs" "append_task_api_server_names(&mut serves)"
