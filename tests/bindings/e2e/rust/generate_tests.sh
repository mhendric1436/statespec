...
api/main.rs
api/servers/provision_api/catalog.rs
...
assert_file_contains "$TMPDIR/out-e2e-rust/api/servers/operator_api/catalog.rs" "constants::OPERATOR_API_SERVER_NAME"
assert_file_contains "$TMPDIR/out-e2e-rust/api/servers/operator_api/catalog.rs" "\"UpsertExternalSystemEndpoint\""
...
assert_file_exists "$TMPDIR/out-api-entities-rust/api/servers/entity_api/catalog.rs"
assert_file_exists "$TMPDIR/out-api-entities-rust/api/servers/entity_api/entities/account.rs"
assert_file_exists "$TMPDIR/out-api-entities-rust/api/servers/entity_api/entities/project.rs"
assert_file_exists "$TMPDIR/out-api-entities-rust/api/servers/entity_api/entities/task.rs"
...
assert_file_contains "$TMPDIR/out-api-entities-rust/api/servers/entity_api/constants.rs" "pub const ENTITY_API_SERVER_CONCURRENCY: i32 = 1"
assert_file_not_contains "$TMPDIR/out-api-entities-rust/api/servers/entity_api/constants.rs" "CreateAccount"
assert_file_contains "$TMPDIR/out-api-entities-rust/api/servers/entity_api/entities/account.rs" "entity_catalog::api_names()"
assert_file_contains "$TMPDIR/out-api-entities-rust/api/servers/entity_api/entities/account.rs" "entity_catalog::constants::CREATE_ACCOUNT_API_NAME"
assert_file_contains "$TMPDIR/out-api-entities-rust/api/servers/entity_api/catalog.rs" "constants::ENTITY_API_SERVER_NAME"
assert_file_contains "$TMPDIR/out-api-entities-rust/api/servers/entity_api/entities/account.rs" "pub fn append_api_server_names"
assert_file_contains "$TMPDIR/out-api-entities-rust/api/servers/entity_api/catalog.rs" "entity_account::append_api_server_names(&mut serves)"
assert_file_contains "$TMPDIR/out-api-entities-rust/api/servers/entity_api/catalog.rs" "entity_project::append_api_server_names(&mut serves)"
assert_file_contains "$TMPDIR/out-api-entities-rust/api/servers/entity_api/catalog.rs" "entity_task::append_api_server_names(&mut serves)"
assert_file_not_contains "$TMPDIR/out-api-entities-rust/api/servers/entity_api/catalog.rs" "fn append_account_api_server_names"
...
assert_file_not_contains "$TMPDIR/out-api-entities-rust/api/descriptors/catalog.rs" "\"CreateAccount\""
assert_file_not_contains "$TMPDIR/out-api-entities-rust/api/descriptors/catalog.rs" "api_names()"
assert_file_contains "$TMPDIR/out-api-entities-rust/api/api_descriptors.rs" "server_entity_api_catalog::api_server_descriptors()"
...
assert_file_contains "$TMPDIR/out-app-rust/worker/worker_process.rs" "pub workflow_step_invokers: Arc<WorkflowStepInvokerMap<B>>"
assert_file_contains "$TMPDIR/out-app-rust/worker/main.rs" "WorkerProcess::new"
assert_file_not_contains "$TMPDIR/out-app-rust/worker/main.rs" "DefaultWorkflowStepHandlerBundle"
assert_file_contains "$TMPDIR/out-app-rust/worker/main.rs" "let mut workflow_step_invokers = WorkflowStepInvokerMap::new();"
assert_file_contains "$TMPDIR/out-app-rust/worker/main.rs" "workflow_provision_service_registry::register_workflow_step_invokers::<InMemoryBackend>"
...
assert_file_contains "$TMPDIR/out-app-rust/worker/workflow_runner.rs" "thread::scope"
assert_file_contains "$TMPDIR/out-app-rust/worker/workflow_runner.rs" "workflow_keep_alive_interval"
assert_file_contains "$TMPDIR/out-app-rust/worker/workflow_runner.rs" "take_keep_alive_error"
assert_file_contains "$TMPDIR/out-app-rust/worker/workflow_step_handlers.rs" "pub struct WorkflowStepKey"
assert_file_contains "$TMPDIR/out-app-rust/worker/workflow_step_handlers.rs" "pub workflow_name: String"
assert_file_contains "$TMPDIR/out-app-rust/worker/workflow_step_handlers.rs" "pub workflow_version: i64"
assert_file_contains "$TMPDIR/out-app-rust/worker/workflow_step_handlers.rs" "pub step_name: String"
...
assert_file_contains "$TMPDIR/out-app-rust/worker/workflow_step_handlers.rs" "pub type WorkflowStepInvoker<B> ="
assert_file_contains "$TMPDIR/out-app-rust/worker/workflow_step_handlers.rs" "&mut <B as Backend>::Tx"
assert_file_contains "$TMPDIR/out-app-rust/worker/workflow_step_handlers.rs" "pub enum WorkflowStepResult"
assert_file_not_contains "$TMPDIR/out-app-rust/worker/workflow_step_handlers.rs" "WorkflowStepHandlerBundle"
assert_file_not_contains "$TMPDIR/out-app-rust/worker/workflow_step_handlers.rs" "DefaultWorkflowStepHandlerBundle"
assert_file_contains "$TMPDIR/out-app-rust/worker/workflows/provision_service/registry.rs" "workflow_step_key(\"ProvisionService\", 1, \"validate_request\")"
assert_file_contains "$TMPDIR/out-app-rust/worker/workflows/provision_service/registry.rs" "workflow_step_key(\"ProvisionService\", 1, \"create_remote_service\")"
assert_file_contains "$TMPDIR/out-app-rust/worker/workflows/provision_service/registry.rs" "workflow_step_key(\"ProvisionService\", 1, \"wait_for_remote_service\")"
assert_file_contains "$TMPDIR/out-app-rust/worker/worker_registry.rs" "new_workflow_step_invoker_map"
...
assert_file_not_contains "$TMPDIR/out-app-rust/worker/workflow_step_handlers.rs" "ProvisionServiceV1StepHandler"
assert_file_contains "$TMPDIR/out-app-rust/worker/workflows/provision_service/handlers.rs" "pub trait ProvisionServiceV1StepHandler<B: Backend>"
assert_file_contains "$TMPDIR/out-app-rust/worker/workflows/provision_service/handlers.rs" "BackendResult<WorkflowStepResult>"
assert_file_contains "$TMPDIR/out-app-rust/worker/workflows/provision_service/handlers.rs" "handle_validate_request(&self, tx: &mut B::Tx, context: &WorkflowStepHandlerContext)"
assert_file_contains "$TMPDIR/out-app-rust/worker/workflow_runner.rs" "pub workflow_step_invokers: &'a WorkflowStepInvokerMap<B>"
assert_file_contains "$TMPDIR/out-app-rust/worker/workflow_runner.rs" "let mut tx = match self.backend.begin()"
assert_file_contains "$TMPDIR/out-app-rust/worker/workflow_runner.rs" "self.run_claimed_step_tx(&mut tx, record)"
assert_file_contains "$TMPDIR/out-app-rust/worker/workflow_runner.rs" "self.revalidate_claimed_step(tx, &claimed)"
assert_file_contains "$TMPDIR/out-app-rust/worker/workflow_runner.rs" "invoker(self.backend, tx, &context)"
assert_file_contains "$TMPDIR/out-app-rust/worker/workflow_runner.rs" ".complete_step_tx("
assert_file_contains "$TMPDIR/out-app-rust/worker/workflow_runner.rs" ".fail_step_tx("
assert_file_contains "$TMPDIR/out-app-rust/worker/workflow_runner.rs" ".cancel_tx("
assert_file_contains "$TMPDIR/out-app-rust/worker/workflow_runner.rs" "unknown generated workflow step handler: {}"
assert_file_contains "$TMPDIR/out-app-rust/worker/workflow_runner.rs" "WorkflowStepResult::Complete { next_step }"
assert_file_contains "$TMPDIR/out-app-rust/worker/workflow_runner.rs" "WorkflowStepResult::Fail { reason }"
assert_file_contains "$TMPDIR/out-app-rust/worker/workflow_runner.rs" "WorkflowStepResult::Cancel { reason }"
assert_file_not_contains "$TMPDIR/out-app-rust/worker/workflow_runner.rs" "next_step ="
assert_file_not_exists "$TMPDIR/out-app-rust/worker/workflows/provision_service.rs"
assert_rust_workflow_result_regression "$TMPDIR/out-app-rust"
