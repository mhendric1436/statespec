...
assert_file_contains "$TMPDIR/out-app-rust/api/api_dispatcher.rs" "OnceLock<HashMap<&'static str, ApiHandlerInvoker>>"
assert_file_contains "$TMPDIR/out-app-rust/api/api_dispatcher.rs" "api_route_lookup_map().get(route_name).cloned()"
assert_file_contains "$TMPDIR/out-app-rust/api/api_dispatcher.rs" "api_handler_lookup_map().get"
