...
assert_file_contains "$TMPDIR/out-api-entities-cpp/api/api_handler_registry.hpp" "repository.listByIndexTx"
...
assert_file_contains "$TMPDIR/out-api-entities-cpp/api/api_handler_registry.hpp" "const auto requested_status = std::string{\"Deleted\"}"
