...
assert_file_contains "$TMPDIR/out-app-cpp/worker/main.cpp" "DefaultWorkflowStepHandlerBundle"
assert_file_contains "$TMPDIR/out-app-cpp/worker/main.cpp" "auto invokers = statespec_generated::worker::workflow_step_invokers(handlers);"
