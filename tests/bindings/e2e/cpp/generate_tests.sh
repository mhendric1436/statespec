...
assert_file_contains "$TMPDIR/out-api-entities-cpp/api/servers/entity_api/catalog.hpp" "append_account_api_server_names"
assert_file_contains "$TMPDIR/out-api-entities-cpp/api/servers/entity_api/catalog.hpp" "append_project_api_server_names(serves)"
assert_file_contains "$TMPDIR/out-api-entities-cpp/api/servers/entity_api/catalog.hpp" "append_task_api_server_names(serves)"
