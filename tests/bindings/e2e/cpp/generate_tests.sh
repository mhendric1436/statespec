...
assert_file_contains "$TMPDIR/out-api-entities-cpp/common/descriptors.hpp" "listByTenantProjectTx"
assert_file_contains "$TMPDIR/out-api-entities-cpp/common/descriptors.hpp" "listByTenantTaskTx"
assert_file_contains "$TMPDIR/out-api-entities-cpp/common/descriptors.hpp" "listByAccountPriorityTx"
assert_file_contains "$TMPDIR/out-api-entities-cpp/common/descriptors.hpp" "inline constexpr const char* kAccountEntityName = \"Account\""
assert_file_contains "$TMPDIR/out-api-entities-cpp/common/descriptors.hpp" "inline constexpr const char* kAccountFieldTenantId = \"tenant_id\""
assert_file_contains "$TMPDIR/out-api-entities-cpp/common/descriptors.hpp" "inline constexpr const char* kAccountFieldCreatedAtTypeName = \"timestamp\""
assert_file_contains "$TMPDIR/out-api-entities-cpp/common/descriptors.hpp" "inline constexpr const char* kAccountFieldStatusTypeName = \"string\""
assert_file_contains "$TMPDIR/out-api-entities-cpp/common/descriptors.hpp" "inline constexpr const char* kAccountIndexByTenantAccount = \"by_tenant_account\""
assert_file_contains "$TMPDIR/out-api-entities-cpp/common/descriptors.hpp" "FieldDescriptor{kAccountFieldCreatedAt, statespec::backend::FieldType::Timestamp, kAccountFieldCreatedAtTypeName, true}"
assert_file_contains "$TMPDIR/out-api-entities-cpp/common/descriptors.hpp" "FieldDescriptor{kAccountFieldStatus, statespec::backend::FieldType::String, kAccountFieldStatusTypeName, true}"
assert_file_contains "$TMPDIR/out-api-entities-cpp/common/descriptors.hpp" "inline constexpr const char* kCreateAccountRequestShapeName = \"CreateAccountRequest\""
assert_file_contains "$TMPDIR/out-api-entities-cpp/common/descriptors.hpp" "inline constexpr const char* kCreateAccountRequestFieldTenantId = \"tenant_id\""
assert_file_contains "$TMPDIR/out-api-entities-cpp/common/descriptors.hpp" "inline constexpr const char* kCreateAccountRequestFieldTenantIdTypeName = \"string\""
assert_file_contains "$TMPDIR/out-api-entities-cpp/common/descriptors.hpp" "FieldDescriptor{kCreateAccountRequestFieldTenantId, statespec::backend::FieldType::String, kCreateAccountRequestFieldTenantIdTypeName, true}"
assert_file_contains "$TMPDIR/out-api-entities-cpp/common/descriptors.hpp" "{kAccountFieldTenantId, kAccountFieldAccountId}"
...
assert_file_contains "$TMPDIR/out-api-entities-cpp/common/descriptors.hpp" "kProjectStatusDeleted"
