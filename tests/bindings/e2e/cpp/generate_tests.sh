...
assert_file_contains "$TMPDIR/out-api-entities-cpp/api/api_dispatcher.hpp" "api::entities::account::register_handler_invokers(map)"
assert_file_contains "$TMPDIR/out-api-entities-cpp/api/api_dispatcher.hpp" "api::entities::project::register_handler_invokers(map)"
assert_file_contains "$TMPDIR/out-api-entities-cpp/api/api_dispatcher.hpp" "api::entities::task::register_handler_invokers(map)"
...
assert_file_contains "$TMPDIR/out-app-cpp/api/api_dispatcher.hpp" "handler_it->second(handler, context)"
