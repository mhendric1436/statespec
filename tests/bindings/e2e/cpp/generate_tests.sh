...
assert_file_contains "$TMPDIR/out-app-cpp/worker/workflow_step_handlers.hpp" "struct WorkflowStepKey"
assert_file_contains "$TMPDIR/out-app-cpp/worker/workflow_step_handlers.hpp" "std::int64_t workflow_version"
assert_file_contains "$TMPDIR/out-app-cpp/worker/workflow_step_handlers.hpp" "inline std::string workflow_step_key"
...
assert_file_contains "$TMPDIR/out-app-cpp/worker/workflow_step_handlers.hpp" "using WorkflowStepInvoker = std::function<"
assert_file_contains "$TMPDIR/out-app-cpp/worker/workflow_step_handlers.hpp" "using WorkflowStepInvokerMap = std::unordered_map<std::string, WorkflowStepInvoker>"
...
assert_file_contains "$TMPDIR/out-app-cpp/worker/workflows/provision_service/registry.hpp" "handler.handle_validate_request(context);"
...
assert_file_contains "$TMPDIR/out-app-cpp/worker/workflow_runner.hpp" "using WorkflowNextStepResolver"
assert_file_contains "$TMPDIR/out-app-cpp/worker/workflow_runner.hpp" "workflow_next_step_resolvers().find(resolver_key)"
assert_file_contains "$TMPDIR/out-app-cpp/worker/workflow_runner.hpp" "workflow_next_step_key(\"ProvisionService\", 1)"
