...
assert_file_contains "$TMPDIR/out-api-entities-cpp/api/api_handler_registry.hpp" "repository.listByTenantProjectTx"
assert_file_contains "$TMPDIR/out-api-entities-cpp/api/api_handler_registry.hpp" "repository.listByTenantTaskTx"
