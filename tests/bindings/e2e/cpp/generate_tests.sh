...
assert_file_contains "$TMPDIR/out-api-entities-cpp/api/entities/account/handlers.hpp" "document[::statespec_generated::entities::account::kAccountFieldCreatedAt] = statespec::backend::Json{generated_api_timestamp()}"
assert_file_contains "$TMPDIR/out-api-entities-cpp/api/entities/account/handlers.hpp" "document[::statespec_generated::entities::account::kAccountFieldStatus] = statespec::backend::Json{::statespec_generated::entities::account::kAccountStatusActive}"
...
assert_file_contains "$TMPDIR/out-api-entities-cpp/api/entities/account/handlers.hpp" "repository.listByAccountStatusTx"
assert_file_contains "$TMPDIR/out-api-entities-cpp/api/entities/project/handlers.hpp" "repository.listByProjectStatusTx"
...
assert_file_contains "$TMPDIR/out-api-entities-cpp/api/entities/account/catalog.hpp" "handle_list_account_projects"
...
assert_file_contains "$TMPDIR/out-api-entities-cpp/api/shapes.hpp" "create_account_request_shape_descriptors()"
assert_file_contains "$TMPDIR/out-api-entities-cpp/api/entities/account/shapes.hpp" "kCreateAccountRequestShapeName"
assert_file_contains "$TMPDIR/out-api-entities-cpp/api/entities/account/shapes.hpp" "FieldDescriptor{kCreateAccountRequestFieldDisplayName, statespec::backend::FieldType::String, kCreateAccountRequestFieldDisplayNameTypeName, true}"
...
assert_file_contains "$TMPDIR/out-api-entities-cpp/api/entities/project/handlers.hpp" "document[::statespec_generated::entities::project::kProjectFieldUpdatedAt]"
assert_file_contains "$TMPDIR/out-api-entities-cpp/api/entities/project/handlers.hpp" "const auto requested_status = std::string{::statespec_generated::entities::project::kProjectStatusDeleted}"
