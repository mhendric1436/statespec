...
worker/workflow_step_types.hpp
...
assert_file_exists "$TMPDIR/out-api-entities-cpp/api/servers/entity_api/entities/account.hpp"
assert_file_exists "$TMPDIR/out-api-entities-cpp/api/servers/entity_api/entities/project.hpp"
assert_file_exists "$TMPDIR/out-api-entities-cpp/api/servers/entity_api/entities/task.hpp"
...
assert_file_contains "$TMPDIR/out-api-entities-cpp/api/servers/entity_api/entities/account.hpp" "::statespec_generated::api::entities::account::api_names()"
assert_file_contains "$TMPDIR/out-api-entities-cpp/api/servers/entity_api/entities/account.hpp" "::statespec_generated::api::entities::account::constants::kCreateAccountApiName"
assert_file_contains "$TMPDIR/out-api-entities-cpp/api/servers/entity_api/catalog.hpp" "constants::kEntityApiServerName"
assert_file_contains "$TMPDIR/out-api-entities-cpp/api/servers/entity_api/entities/account.hpp" "append_api_server_names"
assert_file_contains "$TMPDIR/out-api-entities-cpp/api/servers/entity_api/catalog.hpp" "entities::account::append_api_server_names(serves)"
assert_file_contains "$TMPDIR/out-api-entities-cpp/api/servers/entity_api/catalog.hpp" "entities::project::append_api_server_names(serves)"
assert_file_contains "$TMPDIR/out-api-entities-cpp/api/servers/entity_api/catalog.hpp" "entities::task::append_api_server_names(serves)"
assert_file_not_contains "$TMPDIR/out-api-entities-cpp/api/servers/entity_api/catalog.hpp" "inline void append_api_server_names"
...
assert_file_not_exists "$TMPDIR/out-workflow-entities-cpp/api/shapes.hpp"
assert_file_not_exists "$TMPDIR/out-workflow-entities-cpp/api/api_handler_registry.hpp"
assert_file_not_exists "$TMPDIR/out-workflow-entities-cpp/api/api_handler_registry_support.hpp"
assert_file_not_exists "$TMPDIR/out-workflow-entities-cpp/api/api_codecs.hpp"
assert_file_not_exists "$TMPDIR/out-workflow-entities-cpp/api/api_descriptors.hpp"
assert_file_not_exists "$TMPDIR/out-workflow-entities-cpp/api/api_codec_support.hpp"
assert_file_not_exists "$TMPDIR/out-workflow-entities-cpp/api/external_system_operator_metadata_api.hpp"
assert_file_not_exists "$TMPDIR/out-workflow-entities-cpp/api/descriptors/catalog.hpp"
assert_file_not_exists "$TMPDIR/out-workflow-entities-cpp/api/api_handlers.hpp"
assert_file_not_exists "$TMPDIR/out-workflow-entities-cpp/api/main.cpp"
assert_file_not_contains "$TMPDIR/out-workflow-entities-cpp/Makefile" "check-api"
...
assert_file_contains "$TMPDIR/out-app-cpp/worker/main.cpp" "WorkflowStepInvokerMap invokers;"
assert_file_contains "$TMPDIR/out-app-cpp/worker/main.cpp" "DefaultProvisionServiceV1StepHandler provision_service_handler"
assert_file_contains "$TMPDIR/out-app-cpp/worker/main.cpp" "register_workflow_step_invokers(invokers, provision_service_handler)"
assert_file_not_contains "$TMPDIR/out-app-cpp/worker/main.cpp" "DefaultWorkflowStepHandlerBundle"
assert_file_not_contains "$TMPDIR/out-app-cpp/worker/main.cpp" "workflow_step_invokers(handlers)"
assert_file_contains "$TMPDIR/out-app-cpp/worker/main.cpp" "WorkerProcess process{runtime, invokers};"
...
assert_file_contains "$TMPDIR/out-app-cpp/worker/workflow_runner.hpp" "class PeriodicWorkflowKeepAlive"
assert_file_contains "$TMPDIR/out-app-cpp/worker/workflow_runner.hpp" "keep_alive.start()"
assert_file_contains "$TMPDIR/out-app-cpp/worker/workflow_runner.hpp" "keep_alive.stop()"
assert_file_contains "$TMPDIR/out-app-cpp/worker/workflow_step_types.hpp" "struct WorkflowStepKey"
assert_file_contains "$TMPDIR/out-app-cpp/worker/workflow_step_types.hpp" "std::int64_t workflow_version"
assert_file_contains "$TMPDIR/out-app-cpp/worker/workflow_step_types.hpp" "inline std::string workflow_step_key"
assert_file_contains "$TMPDIR/out-app-cpp/worker/workflow_step_types.hpp" "workflow_name + \":\" + std::to_string(workflow_version) + \":\" + step_name"
assert_file_contains "$TMPDIR/out-app-cpp/worker/workflow_step_types.hpp" "std::string encode() const"
assert_file_contains "$TMPDIR/out-app-cpp/worker/workflow_step_types.hpp" "enum class WorkflowStepResultKind"
assert_file_contains "$TMPDIR/out-app-cpp/worker/workflow_step_types.hpp" "struct WorkflowStepResult"
assert_file_contains "$TMPDIR/out-app-cpp/worker/workflow_step_types.hpp" "using WorkflowStepInvoker = std::function<"
assert_file_contains "$TMPDIR/out-app-cpp/worker/workflow_step_types.hpp" "using WorkflowStepInvokerMap = std::unordered_map<std::string, WorkflowStepInvoker>"
assert_file_contains "$TMPDIR/out-app-cpp/worker/workflow_step_types.hpp" "statespec::backend::IBackend& backend"
assert_file_contains "$TMPDIR/out-app-cpp/worker/workflow_step_types.hpp" "const WorkflowStepHandlerContext& context"
assert_file_contains "$TMPDIR/out-app-cpp/worker/workflow_step_handlers.hpp" "DefaultWorkflowStepHandlerBundle"
...
assert_file_contains "$TMPDIR/out-app-cpp/worker/workflows/provision_service/registry.hpp" "ProvisionServiceV1StepHandler& handler"
assert_file_contains "$TMPDIR/out-app-cpp/worker/workflows/provision_service/registry.hpp" "[&handler]"
assert_file_contains "$TMPDIR/out-app-cpp/worker/workflows/provision_service/registry.hpp" "return handler.handle_validate_request(tx, context);"
assert_file_contains "$TMPDIR/out-app-cpp/worker/workflow_runner.hpp" "workflow_store_.complete_stepTx"
assert_file_contains "$TMPDIR/out-app-cpp/worker/workflow_runner.hpp" "revalidate_claimed_step"
assert_file_contains "$TMPDIR/out-app-cpp/worker/workflows/provision_service/registry.hpp" "workflow_step_key(\"ProvisionService\", 1, \"validate_request\")"
assert_file_contains "$TMPDIR/out-app-cpp/worker/workflows/provision_service/registry.hpp" "workflow_step_key(\"ProvisionService\", 1, \"create_remote_service\")"
assert_file_contains "$TMPDIR/out-app-cpp/worker/workflows/provision_service/registry.hpp" "workflow_step_key(\"ProvisionService\", 1, \"wait_for_remote_service\")"
...
assert_file_contains "$TMPDIR/out-app-cpp/worker/workflows/provision_service/handlers.hpp" "WorkflowStepResult handle_validate_request"
assert_file_contains "$TMPDIR/out-app-cpp/worker/workflow_runner.hpp" "const WorkflowStepInvokerMap& invokers"
assert_file_contains "$TMPDIR/out-app-cpp/worker/workflow_runner.hpp" "const auto invoker = invokers_.find(key)"
assert_file_contains "$TMPDIR/out-app-cpp/worker/workflow_runner.hpp" "result = invoker->second(backend_, *tx, context)"
assert_file_contains "$TMPDIR/out-app-cpp/worker/workflow_runner.hpp" "result.kind == WorkflowStepResultKind::Fail"
assert_file_contains "$TMPDIR/out-app-cpp/worker/workflow_runner.hpp" "result.kind == WorkflowStepResultKind::Cancel"
assert_file_not_contains "$TMPDIR/out-app-cpp/worker/workflow_runner.hpp" "WorkflowNextStepResolver"
assert_file_not_contains "$TMPDIR/out-app-cpp/worker/workflow_runner.hpp" "workflow_next_step_resolvers"
assert_file_not_contains "$TMPDIR/out-app-cpp/worker/workflow_runner.hpp" "if (!next_step.has_value())"
assert_file_not_contains "$TMPDIR/out-app-cpp/worker/workflow_runner.hpp" "WorkflowStepHandlerBundle&"
