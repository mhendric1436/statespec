...
assert_file_contains "$TMPDIR/out-api-entities-cpp/api/entities/account/handlers.hpp" "document[::statespec_generated::entities::account::constants::kAccountFieldCreatedAt] = statespec::backend::Json{generated_api_timestamp()}"
...
assert_file_contains "$TMPDIR/out-api-entities-cpp/api/descriptors/create_account.hpp" "#include \"../../common/entities/account/constants.hpp\""
assert_file_contains "$TMPDIR/out-api-entities-cpp/api/descriptors/create_account.hpp" "std::string{\"/v1/tenants/{\"} + ::statespec_generated::entities::account::constants::kAccountFieldTenantId"
assert_file_not_contains "$TMPDIR/out-api-entities-cpp/api/descriptors/create_account.hpp" "common/descriptors.hpp"
assert_file_not_contains "$TMPDIR/out-api-entities-cpp/api/descriptors/create_account.hpp" "model.hpp"
assert_file_contains "$TMPDIR/out-api-entities-cpp/api/descriptors/create_project.hpp" "#include \"../../common/entities/project/constants.hpp\""
assert_file_contains "$TMPDIR/out-api-entities-cpp/api/descriptors/create_project.hpp" "::statespec_generated::entities::project::constants::kProjectFieldProjectId"
assert_file_contains "$TMPDIR/out-api-entities-cpp/api/descriptors/create_task.hpp" "#include \"../../common/entities/task/constants.hpp\""
assert_file_contains "$TMPDIR/out-api-entities-cpp/api/descriptors/create_task.hpp" "::statespec_generated::entities::task::constants::kTaskFieldTaskId"
assert_tree_files_not_contains "$TMPDIR/out-api-entities-cpp/api/descriptors" "*.hpp" "common/descriptors.hpp"
assert_tree_files_not_contains "$TMPDIR/out-api-entities-cpp/api/descriptors" "*.hpp" "model.hpp"
...
assert_file_contains "$TMPDIR/out-api-entities-cpp/api/api_handler_registry.hpp" "api::entities::account::HandlerRegistry"
