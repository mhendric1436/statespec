...
assert_file_exists "$TMPDIR/out-java/build.gradle"
assert_file_exists "$TMPDIR/out-java/com/statespec/generated/ApiArtifacts.java"
assert_file_exists "$TMPDIR/out-java/com/statespec/generated/WorkerArtifacts.java"
assert_file_contains "$TMPDIR/out-java/build.gradle" "id 'java-library'"
assert_file_contains "$TMPDIR/out-java/build.gradle" "languageVersion = JavaLanguageVersion.of(17)"
assert_file_contains "$TMPDIR/out-java/build.gradle" "srcDirs = ['.']"
assert_file_contains "$TMPDIR/out-java/com/statespec/generated/ApiArtifacts.java" "class ApiArtifacts"
assert_file_contains "$TMPDIR/out-java/com/statespec/generated/ApiArtifacts.java" "apiRouteDescriptors"
assert_file_contains "$TMPDIR/out-java/com/statespec/generated/WorkerArtifacts.java" "class WorkerArtifacts"
assert_file_contains "$TMPDIR/out-java/com/statespec/generated/WorkerArtifacts.java" "workerContexts"
assert_file_contains "$TMPDIR/out-java/com/statespec/generated/WorkerArtifacts.java" "workflowDefinitions"
assert_file_contains "$TMPDIR/out-java/com/statespec/backend/Backend.java" "enum FieldType"
assert_file_contains "$TMPDIR/out-java/com/statespec/backend/Backend.java" "FieldType type"
assert_file_contains "$TMPDIR/out-java/com/statespec/backend/Backend.java" "String typeName"
...
assert_file_contains "$TMPDIR/out-java/com/statespec/generated/Descriptors.java" "Stripe"
...
assert_file_contains "$TMPDIR/out-java/com/statespec/generated/Descriptors.java" "FieldType.STRING"
assert_file_contains "$TMPDIR/out-java/com/statespec/generated/Descriptors.java" "FieldType.NAMED"
assert_file_contains "$TMPDIR/out-java/com/statespec/generated/Descriptors.java" "FieldType.TIMESTAMP"
assert_file_contains "$TMPDIR/out-java/com/statespec/generated/Descriptors.java" "FieldType.OPTIONAL"
assert_file_contains "$TMPDIR/out-java/com/statespec/generated/Descriptors.java" "\"OrderStatus\""
assert_file_contains "$TMPDIR/out-java/com/statespec/generated/Descriptors.java" "\"int?\""

cp "$SCRIPT_DIR/MetadataResolverFixture.java" "$TMPDIR/out-java/com/statespec/generated/MetadataResolverFixture.java"
