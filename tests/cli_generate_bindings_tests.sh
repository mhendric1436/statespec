...
NO_SYSTEM_SPEC="$FIXTURES_DIR/no-system.sspec"
INCLUDED_SPEC="$TMPDIR/included-bindings.sspec"
INCLUDE_ROOT_SPEC="$TMPDIR/include-bindings-root.sspec"
cp "$FIXTURES_DIR/included-bindings.sspec" "$INCLUDED_SPEC"
cp "$FIXTURES_DIR/include-bindings-root.sspec" "$INCLUDE_ROOT_SPEC"
