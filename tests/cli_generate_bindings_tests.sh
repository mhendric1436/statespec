...
assert_file_contains "$TMPDIR/out-cpp/system_descriptors.hpp" "/v1/orders/{order_id}/start"
...
assert_file_contains "$TMPDIR/out-go/backend/descriptors.go" "Path: stringPtr(\"/v1/orders/{order_id}/start\")"
...
assert_file_contains "$TMPDIR/out-java/com/statespec/generated/Descriptors.java" "Optional.of(\"/v1/orders/{order_id}/start\")"
...
assert_file_contains "$TMPDIR/out-rust/descriptors.rs" "path: Some(\"/v1/orders/{order_id}/start\".to_string())"
