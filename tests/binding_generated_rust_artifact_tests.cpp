...
void test_rust_entity_api_catalog_artifacts_are_operation_owned()
{
    ...
    require_generated_artifact_contains(
        ...
        "pub const CREATE_ACCOUNT_API_NAME: &str = \"CreateAccount\""
    );
    require_generated_artifact_contains(
        result, "api/entities/account/constants.rs",
        "pub const ENTITY_API_CREATE_ACCOUNT_ROUTE_NAME: &str = \"EntityApi.CreateAccount\""
    );
    require_generated_artifact_contains(
        result, "api/entities/account/constants.rs",
        "pub const CREATE_ACCOUNT_REQUEST_SHAPE_NAME: &str = \"CreateAccountRequest\""
    );
    require_generated_artifact_contains(
        result, "api/entities/account/constants.rs",
    ...
    require_generated_artifact_contains(
        ...
        "entity_account::registry::register_handler_invokers::<B>(handlers)"
    );
    require_generated_artifact_not_contains(
