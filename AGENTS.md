...
completing, failing, or canceling a claimed step. C++, Go, Java, and Rust generated
workflow runners start a periodic keep-alive controller while the handler transaction is
open. Any periodic keep-alive work must preserve the
