...
{
    return pascal_identifier(entity_name) + "EntityPluralName";
}
...
)
{
    ...
    {
        if (field_name == go_entity_plural_api_field_name(entity.name))
        {
            return "entityconstants." + go_entity_plural_name_constant_name(entity.name);
        }
...
{
    return pascal_identifier(entity_name) + "Index" + pascal_identifier(index_name);
}
