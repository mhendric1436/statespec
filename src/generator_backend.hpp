...
inline std::string output_root(const GenerateDecl& declaration, const GenerationOptions& options)
{
...
inline std::string payload_struct_name(const QueueDecl& queue, const MessageDecl& message)
{
    return queue.name + message.name + "Payload";
}

inline void append_header(std::ostream& out, const SystemDecl& system, const std::string& target)
{
