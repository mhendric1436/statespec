    ...
    while (!check(TokenKind::RightBrace) && !is_at_end())
    {
        if (match(TokenKind::KeywordTenant))
        {
            ...
            system.member_order.push_back(
                BlockMemberOrder{std::string{SyntaxKeywordTenant}, tenant_start.range}
            );
        ...
        else if (is_named_identifier(peek(), SyntaxIdentifierSystemTenant))
        {
            const auto system_tenant_start = advance();
            system.member_order.push_back(
                BlockMemberOrder{
                    std::string{SyntaxIdentifierSystemTenant}, system_tenant_start.range
                }
            );
            if (!is_named_identifier(peek(), SyntaxIdentifierConfigured))
            {
                diagnostics.error(
        ...
        {
            system.member_order.push_back(
                BlockMemberOrder{std::string{SyntaxKeywordEntity}, peek().range}
            );
        ...
        {
            system.member_order.push_back(
                BlockMemberOrder{std::string{SyntaxKeywordValue}, peek().range}
            );
        ...
        {
            system.member_order.push_back(
                BlockMemberOrder{std::string{SyntaxKeywordEnum}, peek().range}
            );
        ...
        {
            system.member_order.push_back(
                BlockMemberOrder{std::string{SyntaxKeywordEvent}, peek().range}
            );
        ...
        {
            system.member_order.push_back(
                BlockMemberOrder{std::string{SyntaxKeywordShape}, peek().range}
            );
        ...
        {
            system.member_order.push_back(
                BlockMemberOrder{std::string{SyntaxKeywordExternalSystem}, peek().range}
            );
        ...
        {
            system.member_order.push_back(
                BlockMemberOrder{std::string{SyntaxKeywordFeatureFlag}, peek().range}
            );
        ...
        {
            system.member_order.push_back(
                BlockMemberOrder{std::string{SyntaxKeywordLog}, peek().range}
            );
        ...
        {
            system.member_order.push_back(
                BlockMemberOrder{std::string{SyntaxKeywordMetric}, peek().range}
            );
        ...
        {
            system.member_order.push_back(
                BlockMemberOrder{std::string{SyntaxKeywordQueue}, peek().range}
            );
        ...
        {
            system.member_order.push_back(
                BlockMemberOrder{std::string{SyntaxKeywordLease}, peek().range}
            );
        ...
        {
            system.member_order.push_back(
                BlockMemberOrder{std::string{SyntaxKeywordWorker}, peek().range}
            );
        ...
        {
            system.member_order.push_back(
                BlockMemberOrder{std::string{SyntaxKeywordApiServer}, peek().range}
            );
        ...
        {
            system.member_order.push_back(
                BlockMemberOrder{std::string{SyntaxKeywordApi}, peek().range}
            );
        ...
        {
            system.member_order.push_back(
                BlockMemberOrder{std::string{SyntaxKeywordWorkflow}, peek().range}
            );
        ...
        {
            system.member_order.push_back(
                BlockMemberOrder{std::string{SyntaxKeywordPolicy}, peek().range}
            );
