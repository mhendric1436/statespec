...
std::vector<BindingAppArtifactModel> binding_app_artifact_model(BindingLanguage language)
{
    ...
    case BindingLanguage::Cpp:
        return {
            ...
            {"api/entity_gc_catalog.hpp", api, Kind::ApiApplication,
             "API-owned entity garbage collection descriptor catalog"},
            ...
            {"worker/entity_gc_catalog.hpp", worker, Kind::WorkerApplication,
             "Worker-owned entity garbage collection descriptor catalog"},
    ...
    case BindingLanguage::Go:
        return {
            ...
            {"api/backend/api_handler_registry.go", api, Kind::ApiHandlerRegistry,
             "API handler registry extension point"},
            {"api/backend/entity_gc_catalog.go", api, Kind::ApiApplication,
             "API-owned entity garbage collection descriptor catalog"},
            ...
            {"worker/backend/worker_runtime.go", worker, Kind::WorkerRuntime,
             "Worker polling and execution runtime"},
            {"worker/backend/entity_gc_catalog.go", worker, Kind::WorkerApplication,
             "Worker-owned entity garbage collection descriptor catalog"},
    ...
    case BindingLanguage::Java:
        return {
            ...
            {"api/com/statespec/generated/ApiHandlerRegistry.java", api, Kind::ApiHandlerRegistry,
             "API handler registry extension point"},
            {"api/com/statespec/generated/EntityGcCatalog.java", api, Kind::ApiApplication,
             "API-owned entity garbage collection descriptor catalog"},
            ...
            {"worker/com/statespec/generated/WorkerRuntime.java", worker, Kind::WorkerRuntime,
             "Worker polling and execution runtime"},
            {"worker/com/statespec/generated/WorkerEntityGcCatalog.java", worker,
             Kind::WorkerApplication, "Worker-owned entity garbage collection descriptor catalog"},
    ...
    case BindingLanguage::Rust:
        return {
            ...
            {"api/api_handler_registry.rs", api, Kind::ApiHandlerRegistry,
             "API handler registry extension point"},
            {"api/entity_gc_catalog.rs", api, Kind::ApiApplication,
             "API-owned entity garbage collection descriptor catalog"},
            ...
            {"worker/worker_runtime.rs", worker, Kind::WorkerRuntime,
             "Worker polling and execution runtime"},
            {"worker/entity_gc_catalog.rs", worker, Kind::WorkerApplication,
             "Worker-owned entity garbage collection descriptor catalog"},
