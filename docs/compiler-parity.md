...
| `external_system` | complete | complete | complete | complete | complete | complete | partial | P3 | External system properties and metadata blocks flow through IR and binding descriptors; ownership-specific semantics remain future work. |
